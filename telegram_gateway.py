...
⚡️ <b>【物理控制台】(零延迟点触指令)</b>
👉 /balance ：调出彭博级资产与多空持仓面板 (或发 <code>查账</code> <code>资产</code>)
👉 /closeall ：最高危！一键市价熔断所有仓位 (或发 <code>快跑</code> <code>平仓</code>)
👉 /logs 15 ：调取底层引擎实时运行日志 (或发 <code>看日志</code>)
👉 /add_symbol ：将新标的纳入最高雷达监控 (或发 <code>添加监控 SOL</code>)

⚔️ <b>【实盘狙击指令】(支持自然语言与U本位自动换算)</b>
💬 <code>做空 1000U 的 BTC，止损 75000</code>
💬 <code>买入 2 个 ETH，止盈 2500，止损 1800</code>
<i>(机甲将自动测算仓位、换算U本位，并调用 Algo 引擎挂载防插针风控)</i>

🛡️ <b>【独立风控指令】(为裸奔仓位极速上膛)</b>
💬 <code>给 ETH 补个 1800 的止损</code>
💬 <code>把 BNB 的止盈设置在 660</code>
<i>(机甲将启动上帝视角，智能识别你的多空方向并精准追加风控单)</i>

🧠 <b>【SMC 机构级推演】(寻找流动性与订单块)</b>
💬 <code>深度分析一下 SOL 的多空动能</code>
💬 <code>帮我看看现在 BTC 的资金费率和流动性池在哪？</code>
<i>(机甲将抓取 48H OHLCV 矩阵与持仓量，输出带盈亏比的华尔街级研报)</i>

======================================
📡 <b>等待指令中... (Type your command)</b>
"""
    # ⚠️ 关键修复：把 parse_mode 改成了 "HTML"
